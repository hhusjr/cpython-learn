...
abs_srcdir=	/Users/zeroisone/CLionProjects/cpython-learn
abs_builddir=	/Users/zeroisone/CLionProjects/cpython-learn
...
CONFIGURE_CPPFLAGS=	-I/usr/local/opt/qt/include
CONFIGURE_LDFLAGS=	-L/usr/local/opt/qt/lib
...
CONFIG_ARGS=	 'LDFLAGS=-L/usr/local/opt/qt/lib' 'CPPFLAGS=-I/usr/local/opt/qt/include'

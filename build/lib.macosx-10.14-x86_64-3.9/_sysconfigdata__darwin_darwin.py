...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': 'gcc -bundle -undefined dynamic_lookup -L/usr/local/opt/qt/lib '
 ...
 'CONFIG_ARGS': "'LDFLAGS=-L/usr/local/opt/qt/lib' "
                "'CPPFLAGS=-I/usr/local/opt/qt/include'",
 'CONFINCLUDEDIR': '/usr/local/include',
 'CONFINCLUDEPY': '/usr/local/include/python3.9',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/Users/zeroisone/CLionProjects/cpython-learn/coverage.info',
 'COVERAGE_REPORT': '/Users/zeroisone/CLionProjects/cpython-learn/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -I./Include -I/usr/local/opt/qt/include '
 ...
 'LDFLAGS': '-L/usr/local/opt/qt/lib -L/usr/local/opt/qt/lib',
 'LDFLAGS_NODIST': '',
 'LDLIBRARY': 'libpython3.9.a',
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -bundle -undefined dynamic_lookup -L/usr/local/opt/qt/lib '
             '-L/usr/local/opt/qt/lib',
 'LDVERSION': '3.9',
 'LIBC': '',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wno-unused-result -Wsign-compare '
                             ...
                             '-I./Include -I/usr/local/opt/qt/include '
                             '-I/usr/local/opt/qt/include '
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code '
                   ...
                   '-I/usr/local/opt/qt/include -I/usr/local/opt/qt/include '
                   '-DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-L/usr/local/opt/qt/lib -L/usr/local/opt/qt/lib',
 'PY_CPPFLAGS': '-I. -I./Include -I/usr/local/opt/qt/include '
                '-I/usr/local/opt/qt/include',
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-L/usr/local/opt/qt/lib -L/usr/local/opt/qt/lib',
 'PY_LDFLAGS_NODIST': '',
